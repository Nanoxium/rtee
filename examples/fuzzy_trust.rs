...
fn main() {
    ...
    let reputation = FuzzyVariable::new("reputation", vec![low_trust.clone(), medium_trust.clone(), high_trust.clone()], Rc::new(|_| 0.0));
    let transaction_history = FuzzyVariable::new("transaction_history", vec![low_trust.clone(), medium_trust.clone(), high_trust.clone()], Rc::new(|_| 0.0));
    let trust_level = FuzzyVariable::new("trust_level", vec![low_trust.clone(), medium_trust.clone(), high_trust.clone()], Rc::new(|total_weight| total_weight / 3.0));
